...
class EmployerController extends Controller
{
    ...
    {   
        ...
        $jobpostCount = DB::table('postjob')->count();
        // echo "<pre>";
        ...
        return view('employer.employerdashboard')->with(
            [
                ...
                'ShotlistedCandidateCount' => $shortlist_cand_count,
    ...
    public function applyByCandidateList(){
        ...
        $joblist = DB::table('jobs_apply')
                        ...
                        ->select('jobs_apply.*','employer.name as employer_name','employer.email','employer.company_name','employer.contact_person','employer.mobile_number'  ,'postjob.job_title' ,'postjob.app_deadline','postjob.vassel_type' , 'postjob-wages.rank_position', 'candidates.name as candidate_name', 'candidates.nationality', 'candidates.availablefrom', 'candidates.phone_number' , 'candidates.experience_years', 'candidates.experience_months')
    ...
    public function downloadResume($id)
    {
        ...
        // echo '<pre>';
        print_r($candidateData[0]->resume_file);
        // exit;
        //PDF file is stored under project/public/download/info.pdf
        
        // echo $file= url('/public/resume/'.$candidateData[0]->resume_file);
