        ...
        <div class="container">
            <div class="col-lg-8 col-md-8 col-sm-12 col-lg-offset-2 col-md-offset-2">
                ...
                <div class='row'>
                    ...
                    <tr>
                        <th style="width:70%; text-align:center;" >User Email varification status: </th>
                        <th style="width:30%"><span style='color:red;'>Not Varified</span>
                        <!-- <img src="{{ asset('assets/img/not-varified.png')}}" width='20' height='20' alt='verification-img-status'/> -->
                        </th> 
                    </tr>
                    </table>
                </div>
