	...
	<div class="container">            
		...
		<div class="collapse navbar-collapse" id="navbar-menu">
			<ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
				<li class="dropdown homelesscaret">
				...
				<li class="">
					<a href="{{ route('contactus.load') }}" class="dropdown-toggle" data-toggle="dropdown">Contact Us</a>
				</li>
				<li class="dropdown">
                ...
                <li>
					...
					<a href="{{ route('signin.index') }}"><i class="" aria-hidden="true"></i>Signin</a>
				</li>
				@endif
			</ul>
				<ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
